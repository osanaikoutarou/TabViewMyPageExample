                ...
                .onPreferenceChange(ScrollOffsetPreferenceKey.self) { scroll in
                    ...
                    if isShowingThisScreen {
                        ...
                        if scroll < scrollableHeight - thin {
                            ...
                            scrollOffsetForBeta = max(scrollOffsetForBeta, min(scroll, scrollableHeight - thin))
                        }
                    }
                }
                .onAppear {
                    ...
                    let unitPoint = UnitPoint.calcUnitPointY(y: -scrollOffsetForOmega, scrollViewHeight: geometryProxy.size.height)
